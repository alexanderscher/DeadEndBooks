...
const AdminNav = ({ isSmallDevice }: Props) => {
  return (
    <div
      className={
    ...
    >
      ...
      >
        <Link href="/profile">Add Book</Link>
      </h1>
      <h1
        className={`mr-6 ${
          isSmallDevice ? "text-[24px]" : "text-[28px]"
      ...
      >
        <Link href="/profile/current-rentals">See All Books</Link>
      </h1>
      <h1
        className={`mr-6 ${
          isSmallDevice ? "text-[24px]" : "text-[28px]"
      ...
      >
        <Link href="/profile/history">Users</Link>
      </h1>
      <h1
        className={`mr-6 ${
          isSmallDevice ? "text-[24px]" : "text-[28px]"
